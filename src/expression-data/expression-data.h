...
typedef void (*ExpressionCompile)(ExpressionData *self, bool address, FILE *out_stream);
...
void expressionCompile(ExpressionData *self, Architecture arch, bool address, FILE *out_stream);
